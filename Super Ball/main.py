...
def main():
    ...
    pygame.time.set_timer(MYTIMER, 1000 * 1)
                    ...
                    for each in group:
                        if each.control:
                            ...
                            if not hole:
                                ...
                                msg = pygame.image.load('win.png').conert_alpha
                                msg_pos = (width - msg.get_widht) // 2, (height - msg.get_height) // 2
